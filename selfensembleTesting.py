...
from modelDefinitions.flareFormer import *
...
model = RetinexFormer(stage=1,n_feat=16,num_blocks=[1,2,2])

modelName = "rfomrer"
checkpointRoot = "/media/nas/81_Models/sharif/cvpr24/lfremoval/checkpoint_rfomrer/"
testImagesPath = "/home/sharif/codeground/CVPR24/FlareRemoal/data/val_input_2k/"
resultDir =  "./EnsambleOutput/"
...
for imgPath in testImageList:
        print(imgPath)
        img, img_dim = modelInference.inputForInference(imgPath)
        img = img.to(device)
